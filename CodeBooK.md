...
7.Set the variable names for the datasets (activityData, subjectData, featuresData) 
...
Checking the data at this moment using “names(InitialData)” shows that the variable names are as follows :
